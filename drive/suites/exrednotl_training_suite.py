...
class ExrednotlTraining(ExperimentSuite):

    def __init__(self):
        super(ExrednotlTraining, self).__init__('Town01')
    ...
    def build_experiments(self):
        ...
        vehicles_tasks = [0, 100]
        pedestrians_tasks = [0, 250]

        task_names = ['empty',  'cluttered']
