...
def medium(image_iteration):
    ...
    augmenter = iaa.Sequential([
        ...
        iaa.Sometimes(frequency_factor, iaa.AdditiveGaussianNoise(loc=0,
        ...
        iaa.Sometimes(frequency_factor, iaa.ContrastNormalization((contrast_factor_neg,
                                                                   contrast_factor_pos),
                                                                  per_channel=color_factor)),
...
def soft(image_iteration):
    ...
    # print ('iteration',iteration,'Augment Status ',frequency_factor,color_factor,dropout_factor,
    # blur_factor,add_factor,
    #    multiply_factor_pos,multiply_factor_neg,contrast_factor_pos,contrast_factor_neg)
