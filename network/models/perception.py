...
from network.models.perception import Conv8FC2



def Perception(architecture_name):
    ...
    if architecture_name == 'Conv8FC2':

        return Conv8FC2()

    else:

        raise ValueError(" Not found perception architecture name")