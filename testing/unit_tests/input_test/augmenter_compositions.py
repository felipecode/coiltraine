...
mult_random_color_sometimes = Augmenter(
    [ToGPU(), Sometimes(Multiply((0.7, 1.3), per_channel=0.5), 1.0)])
...
coarse_dropout_random_color = Augmenter(
    [ToGPU(), CoarseDropout((0.0, 0.20), size_px=(16, 16), per_channel=0.5)])
...
contrast_normalization_test_color = Augmenter(
    [ToGPU(), ContrastNormalization((0.5, 1.5), per_channel=0.5)])
