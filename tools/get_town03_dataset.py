...
if __name__ == "__main__":
    ...
    file_id = '18XgqpR4Kxq14_oC9jJ-RHZS0aqscwxcD'
    destination_pack = 'CoILTrainTown03.tar.gz'

    print("Downloading the training dataset for Town03  (5GB total)")
    ...
    tf = tarfile.open("CoILTrainTown03.tar.gz")
    tf.extractall(destination_final)

    os.remove("CoILTrainTown03.tar.gz")