...
def get_latest_saved_checkpoint(exp_batch, exp_alias):
    ...
    # TODO: Change the sorted function to something that takes into acount the last integer from file
    checkpoint_files = sorted(os.listdir(os.path.join(exp_batch, exp_alias, 'checkpoints')))
