...
processing_params = {'Success rate':   {'metric': 'control_success_rate', 'filter': {}, 'params': {}},
                     ...
                     'Cumulative displacement 16 steps': {'metric': 'cumulative_displacement',
                                                          ...
                                                          'params': {'window': 16, 'timestep': 0.1,
                                                                     'aggregate': {
                                                                         'type': 'mean'}}},
                     'Cumulative displacement 64 steps': {'metric': 'cumulative_displacement',
                                                          'filter': data_filter,
                                                          'params': {'window': 16, 'timestep': 0.1,
                                                                     'aggregate': {
                                                                         'type': 'mean'}}},
...
plot_params['ctrl_vs_cum_disp64'] = {'print': True,
                                     'x': {'data': 'Cumulative displacement 64 steps', 'log': True},
                                     'y': {'data': 'Success rate', 'log': False},
                                     'size': {'data': 'step'},
                                     'color': {'data': 'town_id'}
                                     }
...
plot_params['ctrl_vs_accuracy_0002'] = {'print': True,
                                   'x': {'data': 'Steering accuracy 0.002', 'log': True},
                                   'y': {'data': 'Success rate', 'log': False},
                                   'size': {'data': 'step'},
                                   'color': {'data': 'town_id'}
                                   }
                     
plot_params['ctrl_vs_accuracy_0005'] = {'print': True,
                                   'x': {'data': 'Steering accuracy 0.005', 'log': True},
                                   'y': {'data': 'Success rate', 'log': False},
                                   'size': {'data': 'step'},
                                   'color': {'data': 'town_id'}
                                   }
                     
plot_params['ctrl_vs_accuracy_001'] = {'print': True,
                                   'x': {'data': 'Steering accuracy 0.01', 'log': True},
                                   'y': {'data': 'Success rate', 'log': False},
                                   'size': {'data': 'step'},
                                   'color': {'data': 'town_id'}
                                   }
                     
plot_params['ctrl_vs_accuracy_003'] = {'print': True,
                                   'x': {'data': 'Steering accuracy 0.03', 'log': True},
                                   'y': {'data': 'Success rate', 'log': False},
                                   'size': {'data': 'step'},
                                   'color': {'data': 'town_id'}
                                   }
